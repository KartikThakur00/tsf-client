                ...
                {customers.map((customer) => (
                  <tr key={customer._id} className="text-justify">
                    ...
                    <td className="border-b-2 px-4 py-3">
                      <Link href={`/customers/${customer._id}`} className="py-1.5 px-4 border-2 border-purple-400 rounded-md bg-purple-500 hover:bg-purple-400 duration-300 ease-in-out text-white font-semibold">Select</Link>
                    </td>
                  </tr>
                ))}
              </tbody>
